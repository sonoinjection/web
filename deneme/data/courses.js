...
export const COURSES = [
  {
    ...
    schedule: {
      tr: [
        ...
        { time: '09:00–10:30', type: 'lecture', title: 'Anatomik Temeller ve Ultrason Tekrarı' },
        { time: '10:45–12:30', type: 'cadaver', title: 'İstasyon 1 — Omuz Kompleksi' },
        { time: '12:30–13:30', type: 'admin', title: 'Öğle Yemeği ve Eğitmen S&C' },
        { time: '13:30–15:30', type: 'cadaver', title: 'İstasyon 2 — Kalça ve İnguinal Bölge' },
        { time: '15:45–17:30', type: 'cadaver', title: 'İstasyon 3 — Diz ve Ayak Bileği' },
        { time: '17:30–18:00', type: 'admin', title: 'Değerlendirme ve Sertifika Töreni' },
      ],
      en: [
        { time: '08:00–09:00', type: 'admin', title: 'Registration & Welcome' },
        { time: '09:00–10:30', type: 'lecture', title: 'Anatomical Foundations & Ultrasound Review' },
        { time: '10:45–12:30', type: 'cadaver', title: 'Station 1 — Shoulder Complex' },
        { time: '12:30–13:30', type: 'admin', title: 'Lunch & Faculty Q&A' },
        { time: '13:30–15:30', type: 'cadaver', title: 'Station 2 — Hip & Groin' },
        { time: '15:45–17:30', type: 'cadaver', title: 'Station 3 — Knee & Ankle' },
        { time: '17:30–18:00', type: 'admin', title: 'Debrief & Certificate Distribution' },
      ],
    },
