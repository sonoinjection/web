/* ============================================================
   api/register.js — public registration endpoint (Supabase pipeline)
   The alternative, database-free path is api/apply.js — see §4 for
   which one /kayit/ is currently wired to.
